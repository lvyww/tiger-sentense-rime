...
def isolated_sources(destination):
    ...
    for name in ("test_tiger_sentence_incremental.lua", "test_rime_contract.lua", "test_sentence_safety.lua", "test_sentence_learning.lua", "test_review_regressions.lua", "test_ngram_reader.lua", "test_memory.lua", "test_reverse_lookup.lua"):
...
def main():
    ...
    with temporary_tree() as root:
        ...
        for script in ("test_tiger_sentence_incremental.lua", "test_rime_contract.lua", "test_sentence_safety.lua", "test_sentence_learning.lua", "test_review_regressions.lua", "test_ngram_reader.lua", "test_memory.lua", "test_reverse_lookup.lua"):
            result = execute(lua, root, script)
